...
Source: https://developer.puter.com/tutorials/access-grok-using-openai-compatible-api/
...
That's it. You now have access to Grok through the OpenAI SDK via Puter, no xAI API key needed. Swap the model string to use any [Grok model](/ai/x-ai/), or any of the hundreds of other [AI models](/ai/models/) available through Puter.
