...
Source: https://developer.puter.com/tutorials/access-deepseek-using-openai-compatible-api/
...
In this tutorial, you'll learn how to access DeepSeek models using the OpenAI SDK through Puter's OpenAI-compatible endpoint. No DeepSeek API key needed, just your Puter auth token.
...
Here's a simple chat completion using DeepSeek V3.2:
...
That's it. You now have access to DeepSeek through the OpenAI SDK via Puter, no DeepSeek API key needed. Swap the model string to use any [DeepSeek model](/ai/deepseek/), from the efficient V3 to the reasoning-focused R1, or any of the hundreds of other [AI models](/ai/models/) available through Puter.
