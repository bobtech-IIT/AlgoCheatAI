...
Source: https://developer.puter.com/tutorials/access-perplexity-using-openai-compatible-api/
...
In this tutorial, you'll learn how to access Perplexity models using the OpenAI SDK through Puter's OpenAI-compatible endpoint. No Perplexity API key needed, just your Puter auth token.
...
Here's a simple chat completion using Sonar:
...
That's it. You now have access to Perplexity through the OpenAI SDK via Puter, no Perplexity API key needed. Swap the model string to use any [Perplexity model](/ai/perplexity/), from the fast Sonar to the powerful Sonar Pro, or any of the hundreds of other [AI models](/ai/models/) available through Puter.
