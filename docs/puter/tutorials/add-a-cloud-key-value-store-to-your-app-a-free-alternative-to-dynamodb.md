...
Source: https://developer.puter.com/tutorials/add-a-cloud-key-value-store-to-your-app-a-free-alternative-to-dynamodb/
...
On this page[Getting Started](#getting-started)[Example 1: Basic Key-Value Operations](#example-1-basic-key-value-operations)[Example 2: Create a Simple User Profile Manager](#example-2-create-a-simple-user-profile-manager)[Example 3: Working with Multiple Keys](#example-3-working-with-multiple-keys)[Example 4: Atomic Operations](#example-4-atomic-operations)

This tutorial will show you how to use [Puter.js](https://developer.puter.com) to add a [key-value store](/key-value-database/) to your web application, providing a free alternative to Amazon DynamoDB. With Puter.js, you can easily store and retrieve data without worrying about setting up a backend or managing a database.
