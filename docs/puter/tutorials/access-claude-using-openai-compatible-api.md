...
Source: https://developer.puter.com/tutorials/access-claude-using-openai-compatible-api/
...
In this tutorial, you'll learn how to access Claude models using the OpenAI SDK through Puter's OpenAI-compatible endpoint. No Anthropic API key needed, just your Puter auth token.
...
Here's a simple chat completion using Claude [Sonnet](/ai/sonnet/) 4.5:
...
That's it. You now have access to Claude through the OpenAI SDK via Puter, no Anthropic API key needed. Swap the model string to use any [Claude model](/ai/anthropic/), from the lightweight [Haiku](/ai/haiku/) to the flagship [Opus](/ai/opus/), or any of the hundreds of other [AI models](/ai/models/) available through Puter.
