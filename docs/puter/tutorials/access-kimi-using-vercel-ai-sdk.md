# How to Use Kimi with the Vercel AI SDK â Moonshot Provider Guide

Source: https://developer.puter.com/tutorials/access-kimi-using-vercel-ai-sdk/
...
On this page[About Kimi](#about-kimi)[Prerequisites](#prerequisites)[Setup](#setup)[Basic Text Generation](#basic-text-generation)[Streaming](#streaming)[Why Use Puter?](#why-use-puter)[Conclusion](#conclusion)[Related](#related)

In this tutorial, you'll learn how to use [Kimi](/ai/kimi/) models with the Vercel AI SDK through Puter's OpenAI-compatible provider endpoint. No Moonshot AI API key needed â just your Puter auth token.
...
- **One API key for everything**  â no need to sign up for separate Moonshot AI, Anthropic, or OpenAI accounts. Your Puter auth token covers all providers.
...
You now have the Moonshot provider set up through the Vercel AI SDK via Puter â no API key needed. Swap the model string to use any [Kimi model](/ai/moonshotai/), from the efficient Kimi Dev to the powerful Kimi K2.5, or any of the hundreds of other [AI models](/ai/models/) available through Puter.
...
- [Moonshot AI Models on Puter](/ai/moonshotai/)
