...
Source: https://developer.puter.com/tutorials/access-kimi-using-openai-compatible-api/
...
In this tutorial, you'll learn how to access [Kimi](/ai/kimi/) models using the OpenAI SDK through Puter's OpenAI-compatible endpoint. No Moonshot AI API key needed, just your Puter auth token.
...
Here's a simple chat completion using Kimi K2:
...
That's it. You now have access to Kimi through the OpenAI SDK via Puter, no Moonshot AI API key needed. Swap the model string to use any [Kimi model](/ai/moonshotai/), from the efficient Kimi Dev to the powerful Kimi K2.5, or any of the hundreds of other [AI models](/ai/models/) available through Puter.
