...
Source: https://docs.puter.com/KV/list/
...
# ![Image](/./assets/img/function.svg)`puter.kv.list()`
...
**Sort numeric keys with zero-padding**
...
**Design keys for query-like filtering with prefix patterns**
