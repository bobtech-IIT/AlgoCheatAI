...
Source: https://docs.puter.com/Perms/requestEmail/
...
# ![Image](/./assets/img/function.svg)`puter.perms.requestEmail()`
...
`requestReadDesktop()`](/./Perms/requestReadDesktop/)[PREVIOUS
