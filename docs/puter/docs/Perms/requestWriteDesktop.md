...
# ![Image](/./assets/img/function.svg)`puter.perms.requestWriteDesktop()`
...
`requestReadDocuments()`](/./Perms/requestReadDocuments/)[PREVIOUS

`requestReadDesktop()`](/./Perms/requestReadDesktop/)