...
Source: https://docs.puter.com/Perms/requestManageApps/
...
# ![Image](/./assets/img/function.svg)`puter.perms.requestManageApps()`
...
`requestReadSubdomains()`](/./Perms/requestReadSubdomains/)[PREVIOUS

`requestReadApps()`](/./Perms/requestReadApps/)