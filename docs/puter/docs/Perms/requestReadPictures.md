...
# ![Image](/./assets/img/function.svg)`puter.perms.requestReadPictures()`
...
`requestWritePictures()`](/./Perms/requestWritePictures/)[PREVIOUS

`requestWriteDocuments()`](/./Perms/requestWriteDocuments/)