...
Source: https://docs.puter.com/Perms/requestReadSubdomains/
...
# ![Image](/./assets/img/function.svg)`puter.perms.requestReadSubdomains()`
...
`requestManageSubdomains()`](/./Perms/requestManageSubdomains/)[PREVIOUS

`requestManageApps()`](/./Perms/requestManageApps/)