...
Source: https://docs.puter.com/Perms/requestReadDesktop/
...
# ![Image](/./assets/img/function.svg)`puter.perms.requestReadDesktop()`
...
`requestWriteDesktop()`](/./Perms/requestWriteDesktop/)[PREVIOUS

`requestEmail()`](/./Perms/requestEmail/)