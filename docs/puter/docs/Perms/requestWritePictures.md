...
Source: https://docs.puter.com/Perms/requestWritePictures/
...
# ![Image](/./assets/img/function.svg)`puter.perms.requestWritePictures()`
...
`requestReadVideos()`](/./Perms/requestReadVideos/)[PREVIOUS

`requestReadPictures()`](/./Perms/requestReadPictures/)