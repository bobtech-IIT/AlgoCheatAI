...
Source: https://docs.puter.com/Perms/requestWriteDocuments/
...
# ![Image](/./assets/img/function.svg)`puter.perms.requestWriteDocuments()`
...
`requestReadPictures()`](/./Perms/requestReadPictures/)[PREVIOUS

`requestReadDocuments()`](/./Perms/requestReadDocuments/)