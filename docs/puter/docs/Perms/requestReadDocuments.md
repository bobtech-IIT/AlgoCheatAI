...
Source: https://docs.puter.com/Perms/requestReadDocuments/
...
# ![Image](/./assets/img/function.svg)`puter.perms.requestReadDocuments()`
...
`requestWriteDocuments()`](/./Perms/requestWriteDocuments/)[PREVIOUS

`requestWriteDesktop()`](/./Perms/requestWriteDesktop/)