...
Source: https://docs.puter.com/Objects/signinresult/
...
# ![Image](/./assets/img/object.svg)`SignInResult`
...
`Speech2TxtResult`](/./Objects/speech2txtresult/)[PREVIOUS

`MonthlyUsage`](/./Objects/monthlyusage/)