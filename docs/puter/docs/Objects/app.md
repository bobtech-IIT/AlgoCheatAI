...
Source: https://docs.puter.com/Objects/app/
...
# ![Image](/./assets/img/object.svg)`App`
...
`CreateAppResult`](/./Objects/createappresult/)[PREVIOUS

`AppConnection`](/./Objects/AppConnection/)