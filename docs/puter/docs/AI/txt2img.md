...
Source: https://docs.puter.com/AI/txt2img/
...
# ![Image](/./assets/img/function.svg)`puter.ai.txt2img()`
...
| `output_quality` | `Number` | flux family | Output quality (0â100). |
...
| `generation_mode` | `String` | Leonardo (`lucid-origin`, `phoenix-1.0`) | Generation tier â affects pricing. e.g. `'standard'`/`'ultra'` (lucid-origin), `'fast'`/`'quality'`/`'ultra'` (phoenix-1.0). |
...
`txt2speech()`](/./AI/txt2speech/)[PREVIOUS

`listModelProviders()`](/./AI/listModelProviders/)