...
Source: https://docs.puter.com/AI/speech2speech/
...
# ![Image](/./assets/img/function.svg)`puter.ai.speech2speech()`
...
- `optimize_streaming_latency` (Number): Latency optimization level (0â4) forwarded to ElevenLabs.
