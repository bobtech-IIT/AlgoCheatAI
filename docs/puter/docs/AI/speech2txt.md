...
Source: https://docs.puter.com/AI/speech2txt/
...
# ![Image](/./assets/img/function.svg)`puter.ai.speech2txt()`
...
- `channels` (Number): Number of audio channels (2â8). Required for multichannel raw audio.
...
`speech2speech()`](/./AI/speech2speech/)[PREVIOUS
