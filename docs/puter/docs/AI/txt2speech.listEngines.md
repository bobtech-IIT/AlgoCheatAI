...
Source: https://docs.puter.com/AI/txt2speech.listEngines/
...
# ![Image](/./assets/img/function.svg)`puter.ai.txt2speech.listEngines()`
...
`txt2speech.listVoices()`](/./AI/txt2speech.listVoices/)[PREVIOUS

`txt2speech()`](/./AI/txt2speech/)