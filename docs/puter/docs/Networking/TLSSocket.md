...
Source: https://docs.puter.com/Networking/TLSSocket/
...
# ![Image](/./assets/img/object.svg)`TLSSocket`

 Websites Puter Apps Node.js Workers

---

The TLS Socket API lets you create a TLS protected TCP socket connection which can be used directly in the browser. The interface is exactly the same as the normal [`puter.net.Socket`](/Networking/Socket/) but connections are encrypted instead of being in plain text.
...
`fetch()`](/./Networking/fetch/)[PREVIOUS
