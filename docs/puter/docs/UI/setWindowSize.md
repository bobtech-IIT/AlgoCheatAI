...
Source: https://docs.puter.com/UI/setWindowSize/
...
# ![Image](/./assets/img/function.svg)`puter.ui.setWindowSize()`
...
`setWindowTitle()`](/./UI/setWindowTitle/)[PREVIOUS

`setWindowPosition()`](/./UI/setWindowPosition/)