...
Source: https://docs.puter.com/UI/showOpenFilePicker/
...
# ![Image](/./assets/img/function.svg)`puter.ui.showOpenFilePicker()`
...
`showSaveFilePicker()`](/./UI/showSaveFilePicker/)[PREVIOUS

`showFontPicker()`](/./UI/showFontPicker/)