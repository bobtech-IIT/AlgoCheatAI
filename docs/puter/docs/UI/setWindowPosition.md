...
Source: https://docs.puter.com/UI/setWindowPosition/
...
# ![Image](/./assets/img/function.svg)`puter.ui.setWindowPosition()`
...
`setWindowSize()`](/./UI/setWindowSize/)[PREVIOUS

`setWindowHeight()`](/./UI/setWindowHeight/)