...
Source: https://docs.puter.com/UI/showFontPicker/
...
# ![Image](/./assets/img/function.svg)`puter.ui.showFontPicker()`
...
`showOpenFilePicker()`](/./UI/showOpenFilePicker/)[PREVIOUS

`showDirectoryPicker()`](/./UI/showDirectoryPicker/)