...
Source: https://docs.puter.com/UI/onLaunchedWithItems/
...
# ![Image](/./assets/img/function.svg)`puter.ui.onLaunchedWithItems()`
...
`onWindowClose()`](/./UI/onWindowClose/)[PREVIOUS

`onItemsOpened()`](/./UI/onItemsOpened/)