...
Source: https://docs.puter.com/UI/setWindowHeight/
...
# ![Image](/./assets/img/function.svg)`puter.ui.setWindowHeight()`
...
`setWindowPosition()`](/./UI/setWindowPosition/)[PREVIOUS

`setMenubar()`](/./UI/setMenubar/)