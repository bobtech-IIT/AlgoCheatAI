...
Source: https://docs.puter.com/UI/alert/
...
# ![Image](/./assets/img/function.svg)`puter.ui.alert()`
...
`notify()`](/./UI/notify/)[PREVIOUS

`authenticateWithPuter()`](/./UI/authenticateWithPuter/)