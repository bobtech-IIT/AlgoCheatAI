...
export const RUBRICS = {
  ...
  article: {
    ...
    params: [
      ...
      { key: "tldr", name: "TL;DR Block", description: "Top-of-article summary for creators" },
...
export function buildTierScanPrompt(topic: string): string {
...
export function buildGeneratePrompt(type: ContentType, topic: string): string {
...
export function buildGenerateWithAlgoCheatPrompt(type: ContentType, topic: string): string {
  const r = RUBRICS[type];
...
export function buildContextQuestionsPrompt(type: ContentType, topic: string, detectedName: string): string {
